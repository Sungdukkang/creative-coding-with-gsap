...
export class Grid {
  ...
  initResizeObserver() {
    // Create a ReseizeObserver instance
  ...
  createBlocks() {
    const blockCount = Math.floor(this.canvas.width / (this.blockWidth + this.blockGap)) + 1;
    const rowCount = Math.floor(this.canvas.height / (this.blockWidth + this.blockGap)) + 1;
